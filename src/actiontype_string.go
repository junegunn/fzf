...
func _() {
	...
	_ = x[actPrevHistorySearch-132]
	_ = x[actPrevSelected-133]
	_ = x[actPrint-134]
	_ = x[actPut-135]
	_ = x[actNextHistory-136]
	_ = x[actNextHistorySearch-137]
	_ = x[actNextSelected-138]
	_ = x[actExecute-139]
	_ = x[actExecuteSilent-140]
	_ = x[actExecuteMulti-141]
	_ = x[actSigStop-142]
	_ = x[actFirst-143]
	_ = x[actLast-144]
	_ = x[actReload-145]
	_ = x[actReloadSync-146]
	_ = x[actDisableSearch-147]
	_ = x[actEnableSearch-148]
	_ = x[actSelect-149]
	_ = x[actDeselect-150]
	_ = x[actUnbind-151]
	_ = x[actRebind-152]
	_ = x[actToggleBind-153]
	_ = x[actBecome-154]
	_ = x[actShowHeader-155]
	_ = x[actHideHeader-156]
	_ = x[actBell-157]
	_ = x[actExclude-158]
	_ = x[actExcludeMulti-159]
	_ = x[actAsync-160]
}
